...
class EjerciciosCasaScreen extends StatefulWidget {
  final Function(int) onEjerciciosCompletados;
  const EjerciciosCasaScreen({
    Key? key, 
    required this.onEjerciciosCompletados,
  }) : super(key: key);

  @override
  State<EjerciciosCasaScreen> createState() => _EjerciciosCasaScreenState();
}

class _EjerciciosCasaScreenState extends State<EjerciciosCasaScreen> {
  ...
  final Map<String, IconData> iconosCategoria = {
    ...
    'Piernas': Icons.home,
    'Cardio': Icons.home,
    'Flexibilidad': Icons.home,
  };

  @override
  void initState() {
    super.initState();
    print('🔄 Iniciando EjerciciosCasaScreen...');
    _cargarEjercicios();
  ...
  Future<void> _cargarEjercicios() async {
    try {
      ...
      if (categorias.isEmpty) {
        throw Exception('No se encontraron categorías de ejercicios');
      }
      ...
      if (ejerciciosPorCategoria.isEmpty) {
        throw Exception('No se encontraron ejercicios en ninguna categoría');
      }
      setState(() {
        isLoading = false;
      });
  ...
  Widget build(BuildContext context) {
    ...
    if (categorias.isEmpty) {
      return const Scaffold(
        body: Center(
          child: Text('No hay categorías de ejercicios disponibles'),
        ),
      );
    }
    return Scaffold(
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    '${_ejerciciosService.ejerciciosCompletadosCasa}/5',
                    style: const TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.bold,
                      fontSize: 16,
          ...
          SizedBox(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                final nombreLimpio = cat.replaceAll(' (Casa)', '');
                final categoriaIcon = iconosCategoria[nombreLimpio] ?? Icons.home;
